...
# DS microservice endpoint
DS_BASE_URL = os.getenv("DS_BASE_URL", "http://ds:8888")
...
def algorithm_run_all():
    ...
    try:
        r = requests.post(
            f"{DS_BASE_URL}/thompson/run_all",
            json={
                "strategy": strategy,
                "persist": True,
                "create_experiment": create_experiment,
...
# ---------------------------------------------------------
# SCHEDULER — Automatically runs DS Thompson Sampling
# ---------------------------------------------------------
...
def scheduled_thompson():
    try:
        requests.post(
            f"{DS_BASE_URL}/thompson/run_all",
            json={"strategy": "gaussian", "persist": True, "create_experiment": False},
            timeout=20,
        )
    except:
        pass
