...
from core import SessionLocal, Project, Bandit, Experiment, get_yerevan_time
...
def run_thompson_for_project(project_id: int, strategy: Strategy = "gaussian", persist: bool = False, create_experiment: bool = False) -> Optional[Dict]:
...
def run_thompson_for_all_projects(strategy: Strategy = "gaussian", persist: bool = False, create_experiment: bool = False) -> Dict[int, Dict]:
    session = SessionLocal()
    try:
